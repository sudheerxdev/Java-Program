...
class LinkedListDemo4{
    public static void main(String[] args) {
        StackLinkedList4 obj = new StackLinkedList4();
        int n ;
        Scanner sc = new Scanner(System.in);
       // System.out.println(obj.pop());
        System.out.println("enter the number of element in the stack ");
        n = sc.nextInt();
        for(int i = 0 ; i < n ; i++){
            int num ;
...
//        System.out.println("the peak elemet is " + obj.peak());
        obj.Print();
        ArrayList<Integer> al = obj.AddElement();
